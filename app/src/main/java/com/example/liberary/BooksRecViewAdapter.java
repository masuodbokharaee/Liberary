        ...
        holder.bookCard.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(context)
                        ...
                        .setMessage("Are you suew you want to delete " + book.getName() + " ? ")
                 ...
                 switch (type){
                     case "want to read":
                         builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                             @Override
                             public void onClick(DialogInterface dialog, int which) {
                                 if(utils.removeWantToReadBooksk((books.get(position)))){
                                     notifyDataSetChanged();
                                     Toast.makeText(context, book.getName() + "has successfuly deleted" , Toast.LENGTH_SHORT).show();
                                 }
                             }
                         }).create().show();
